...
<head>
  ...
  <title>PEMAJUAN HAM | Lampiran</title>
        ...
        <div class="center">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('simpan_lampiran')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">

                  <div class="form-group">
                    <label for="exampleInputFile">Upload TTD</label>
